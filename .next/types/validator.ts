...
// Validate ../../src/app/api/checkBan/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/checkBan">> = Specific
  const handler = {} as typeof import("../../src/app/api/checkBan/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}

// Validate ../../src/app/api/getServers/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/getServers">> = Specific
  const handler = {} as typeof import("../../src/app/api/getServers/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
